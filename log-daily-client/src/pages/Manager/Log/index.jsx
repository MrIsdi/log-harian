...
function LogManager() {
  ...
  return (
    <Layout name="manager">
      ...
      <div className={`bg-slate-800 text-slate-400 w-3/4 p-8 rounded-2xl mb-8`}>
        <a href="/manager/log/create" className="text-slate-800 bg-cyan-400 py-1 px-3 rounded text-xl">Tambah Log Harian</a>
